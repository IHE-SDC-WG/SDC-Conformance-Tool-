...
namespace SDC
{
    public partial class SDCForm : System.Web.UI.Page
    {
                    ...
                    if (xml.Length>0)
                    {
                        ...
                        catch(Exception ex)
                       {
                        ...
                        if (manager_name.ToUpper() != "DCG")  //new xml
                        {
                            ...
                            if(xdoc.SelectSingleNode("//urn:form", mgr)==null)
                            {
                                Page.Controls.Clear();
        ...
        private void ValidateRetrieveResponse(XmlDocument xdoc)
        {
            ...
            settings.Schemas.Add("urn:ihe:iti:rfd:2007", Server.MapPath("Services/Schema/RFD+SDCRetrieveForm.xsd"));
