...
namespace SDC
{
    public partial class SDCFormHTML : System.Web.UI.Page
    {
        ...
        public  string getForm(string formid, string endpoint, string format)
        {
            ...
            //ServicePointManager.SecurityProtocol = SecurityProtocolType.Ssl3 | SecurityProtocolType.Tls | (SecurityProtocolType)3972;
                                ...
                                <soap:Body>
                                    <urn:RetrieveFormRequest>
                                        ...
                                        <urn:workflowData>
                                            ...
                                            <urn:encodedResponse responseContentType='text/" + format + @"+sdc'>true</urn:encodedResponse >
