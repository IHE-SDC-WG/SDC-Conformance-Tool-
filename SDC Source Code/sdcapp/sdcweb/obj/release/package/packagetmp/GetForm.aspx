...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <span><b>Select Content Format</b></span>
       ...
       <asp:RadioButtonList RepeatDirection="Horizontal" ClientIDMode="Static" ID="contentformat" runat="server" >
        <asp:ListItem Text = "XML" Value = "xml"></asp:ListItem>
        <asp:ListItem Text = "HTML" Value = "html"></asp:ListItem>        
        <asp:ListItem Text = "URL" Value = "urn"></asp:ListItem>   
      </asp:RadioButtonList> 
    ...
    <div id="packages" style="display:block" runat="server">
         ...
         <div id="getpackage"  runat="server" style="display:block">
            ...
            <div runat="server" id="divlist" style="display:none">
             ...
             <%--<asp:Button ID="btnRetrierve" ClientIDMode="Static" runat="server" Text="Retrieve"  />--%>
    
             <div id="sitesection">
                <p class="expand-one"><a href="#"><b>Prepop data (only available for URL format)</b></a> </p>
                <div class="content-one">
                    <p>Paste a valid CDA document content here to prepop form</p>
                    <asp:TextBox runat="server" ID="txtPrepop" TextMode="MultiLine" Rows="10" Width="90%" ClientIDMode="Static"></asp:TextBox>
                </div>
            </div>
