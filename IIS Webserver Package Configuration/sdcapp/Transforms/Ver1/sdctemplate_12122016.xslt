						...
						<![CDATA[
							...
							*/
							...
							function CallTestService1(data) {
								...
								//soapAction = "SubmitForm";  //soap 1 ignores action
							...
							*/
							...
							function OnSuccess(data, status) {
								...
								if (document.getElementById("response") != null) {       
									//document.getElementById("response").textContent ="Receiver Response - <pre>" + xmlstring + '</pre>';
									document.getElementById("response").textContent ="Receiver Response - <pre>" + xmlstring + '</pre>';
									//$("#response").text("Receiver Response - <PRE>" + xmlstring + '</PRE>');
